...
class HousingCell: UICollectionViewCell {

    static let reuseIdentifier = "housing-cell-reuse-identifier"
...
class HousingTitleSupplementaryView: UICollectionReusableView {
    let label = UILabel()
