...
extension HousingViewController {
    ...
    func configureDataSource() {
        ...
        <ConferenceVideoCell, HouseModel> { (cell, indexPath, house) in
            // Populate the cell with our item description.
            cell.titleLabel.text = house.name
            cell.categoryLabel.text = String(house.students)
        ...
        <TitleSupplementaryView>(elementKind: HousingViewController.titleElementKind) {
